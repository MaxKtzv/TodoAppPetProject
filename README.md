...
- **Web Framework:** [FastAPI](https://fastapi.tiangolo.com/) - High performance, easy to learn, fast to code, ready for
  production.
- **Database:** [SQLite](https://www.sqlite.org/) - Lightweight and self-contained SQL database.
- **ORM:** [SQLAlchemy](https://www.sqlalchemy.org/) - The Python SQL Toolkit and Object Relational Mapper.
- **Migrations:** [Alembic](https://alembic.sqlalchemy.org/) - A lightweight database migration tool for usage with
  SQLAlchemy.
- **Data Validation:** [Pydantic](https://docs.pydantic.dev/) - Data validation and settings management using Python
  type annotations.
- **Security:** [Python-jose](https://python-jose.readthedocs.io/) (JWT), [Passlib](https://passlib.readthedocs.io/) (
  bcrypt), [Have I Been Pwned](https://haveibeenpwned.com/) (breach detection).
...
- **Templating:** [Jinja2](https://jinja.palletsprojects.com/) - A modern and designer-friendly templating language for
  Python.
- **Styling:** [Bootstrap 5](https://getbootstrap.com/) - Powerful, extensible, and feature-packed frontend toolkit.
- **Interactivity:** [jQuery](https://jquery.com/) - Fast, small, and feature-rich JavaScript library.
...
- **Package Manager:** [uv](https://docs.astral.sh/uv) - An extremely fast Python package installer and resolver.
- **Testing:** [Pytest](https://docs.pytest.org/) - A framework that makes it easy to write small tests, yet scales to
  support complex functional testing.
- **Containerization:** [Docker](https://www.docker.com/) - Tools
